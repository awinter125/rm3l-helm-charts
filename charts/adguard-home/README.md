...
[![Latest version](https://img.shields.io/badge/latest_version-0.12.1-blue)](https://artifacthub.io/packages/helm/rm3l/adguard-home)

## Installation

```bash
$ helm repo add rm3l https://helm-charts.rm3l.org
$ helm install my-adguard-home rm3l/adguard-home --version 0.12.1
```
